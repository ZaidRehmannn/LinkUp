...
const page = () => {
  return (
    <main className="px-6 md:px-20 py-10 max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          <div>
            <span className='flex items-center gap-3'>
              <LockIcon className="text-blue-700 w-5 h-5" />
              <h4 className="font-semibold text-gray-800">How do I reset my password?</h4>
            </span>
          ...
          <div>
            <span className='flex items-center gap-3'>
              <PencilIcon className="text-blue-700 w-5 h-5" />
              <h4 className="font-semibold text-gray-800">How can I create a post?</h4>
            </span>
            <p className="text-gray-600">
          ...
          <div>
            <span className='flex items-center gap-3'>
              <UsersIcon className="text-blue-700 w-5 h-5" />
              <h4 className="font-semibold text-gray-800">How do I connect with others?</h4>
            </span>
            <p className="text-gray-600">
          ...
          <div>
            <span className='flex items-center gap-3'>
              <SmartphoneIcon className="text-blue-700 w-5 h-5" />
              <h4 className="font-semibold text-gray-800">Is LinkUp available on mobile?</h4>
            </span>
            <p className="text-gray-600">
      ...
      <section className="mb-5">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4">Still Need Help?</h2>
        <p className="text-gray-700 mb-2">
          If you didn't find what you were looking for, feel free to reach out to us.
        </p>
        <ul className="text-gray-600 list-disc list-inside">
          <li>Email us at <span className="font-medium text-blue-700">support@linkup.com</span></li>
        </ul>
      </section>
    </main>
  )
