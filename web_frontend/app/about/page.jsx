  ...
  return (
    <main className="px-6 md:px-20 py-10 max-w-7xl mx-auto">
      ...
      <section className="mb-5">
        <h4 className="text-xl font-semibold text-gray-800 mb-2">Who We Are</h4>
      ...
      <section className="mb-5">
        <h4 className="text-xl font-semibold text-gray-800 mb-4">Why LinkUp?</h4>
        <ol className="space-y-4">
          <li className="flex items-center gap-3">
            <FileText className="text-blue-700" />
            <span className="text-gray-600">Create and share posts effortlessly</span>
          </li>
          <li className="flex items-center gap-3">
            <Users className="text-blue-700" />
            <span className="text-gray-600">Build genuine connections with others</span>
          </li>
          <li className="flex items-center gap-3">
            <MessageCircle className="text-blue-700" />
            <span className="text-gray-600">Chat in real-time with a smooth, intuitive interface</span>
          </li>
          <li className="flex items-center gap-3">
            <ShieldCheck className="text-blue-700" />
            <span className="text-gray-600">Privacy-focused — your data stays yours</span>
          </li>
        </ol>
      </section>
